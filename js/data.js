...
const POLITY = {
  elder: {
    n: '守尾制', d: '长老治谷，稳扎稳打。学识与满意度优先，但对外封闭。',
    tier1: 'in',
  ...
  hermit: {
    n: '闭谷修灵', d: '隐居修行，灵性充沛。符咒与学识双高，但经济封闭。',
    tier1: 'in',
    cost: [{ r: 'scroll', a: 80 }, { r: 'coin', a: 80 }, { r: 'ancCoin', a: 10 }],
  ...
  public: {
    n: '合嗓令', d: '公议治谷，均衡发展。政策调整成本低，但建设研究微涨。',
    tier1: 'in',
    cost: [{ r: 'scroll', a: 80 }, { r: 'coin', a: 80 }, { r: 'ancCoin', a: 10 }],
  ...
  martial: {
    n: '野风志', d: '远行治谷，武力开拓。远征强力但经济与满意度承压。',
    tier1: 'out',
    cost: [{ r: 'scroll', a: 80 }, { r: 'coin', a: 80 }, { r: 'ancCoin', a: 10 }],
  ...
  anarchy: {
    n: '散爪活', d: '无人治谷，自由至上。手动采集爆发但建筑长期疲软。',
    tier1: 'out',
    cost: [{ r: 'scroll', a: 80 }, { r: 'coin', a: 80 }, { r: 'ancCoin', a: 10 }],
...
const POLICY = {
  ...
  land: {
    ...
    opts: {
      public:  { n: '公田',   d: '产出普涨，满意度微降。',
                 e: { berryM: .08, woodM: .05, stoneM: .05 }, pen: { hapM: -.03 } },
      private: { n: '私田',   d: '铜钱暴涨，建筑省钱，但采集下降。',
                 e: { coinM: .15, buildCostM: -.05 }, pen: { berryM: -.05 } },
      commune: { n: '共耕',   d: '采集最强，心情好，但铜钱萎缩。',
  ...
  edu: {
    ...
    uq: { u: { policyLore: 1 }, polity: true },
    opts: {
      mentor:  { n: '师徒',   d: '授业便宜，但学识产出略低。',
                 e: { trainCostM: -.30 }, pen: { loreM: -.05 } },
      academy: { n: '书院',   d: '学识与卷轴双高，但授业昂贵。',
                 e: { loreM: .15, scrollM: .10 }, pen: { trainCostM: .20 } },
      self:    { n: '自学',   d: '学识/卷轴微涨，采集经验大涨。',
  ...
  class: {
    ...
    uq: { u: { policyLore: 1 }, polity: true },
    opts: {
      equal:   { n: '平等',     d: '心情好，但职业效率微降。',
                 e: { hapM: .08 }, pen: { jobM: -.03 } },
      seniority: { n: '长幼有序', d: '授业加成，但心情微降。',
                 e: { trainFlat: .5 }, pen: { hapM: -.03 } },
      merit:   { n: '才能至上', d: '职业效率与铜钱双涨，但心情差。',
