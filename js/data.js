...
const SPEC_BD = {
  ...
  lumberYard: {
    A: { n: '往山里走去', d: '圆木 +50%，每座消耗碎石 0.005/s', prodMul: 1.5, drain: { stone: 0.005 },
      tip: ['走远一点，树就粗一点，回来的路就长一点。'] },
    B: { n: '顺手牵皮', d: '圆木 +15%，额外产兽皮 0.002/s', prodMul: 1.15, extraP: { leather: 0.002 },
      tip: ['本来只是砍树，但树上挂着的东西也不能浪费嘛。'] },
  },
  quarry: {
    A: { n: '不惜爪', d: '碎石 +50%，每座消耗圆木 0.005/s', prodMul: 1.5, drain: { wood: 0.005 },
      tip: ['爪子磨秃了再长，石头可不等你。'] },
    B: { n: '歪打正着', d: '碎石 +20%，额外产矿铁 0.001/s', prodMul: 1.2, extraP: { iron: 0.001 },
      tip: ['本来想挖石头，结果挖出来的东西会发光。'] },
  },
  tannery: {
    A: { n: '嚼劲', d: '兽皮 +60%，全村野莓消耗 +10%', prodMul: 1.6, foxEatMul: 1.1,
      tip: ['皮子嚼得越久越软，肚子叫得越久越响。'] },
...
const SPEC_JD = {
  gatherer: {
    ...
    B: { n: '摸鱼高手', d: '产量 +15%，手动采集量 +50%', prodMul: 1.15, gatherMul: 1.5,
      tip: ['看着没在干活，篮子里的莓果倒是没少过。'] },
  },
  woodcutter: {
    A: { n: '跟树杠上了', d: '产量 +40%', prodMul: 1.4,
      tip: ['这棵砍完砍那棵，树倒了还要再踹两脚。'] },
    B: { n: '踢到算我的', d: '产量 +15%，额外产碎石 0.01/s', prodMul: 1.15, extraP: { stone: 0.01 },
      tip: ['路上的石头绊了脚，那就顺便带回去。'] },
  },
  miner: {
    A: { n: '只挖一个坑', d: '产量 +40%', prodMul: 1.4,
      tip: ['别的坑不去，就认准这一个，挖到地心算完。'] },
    B: { n: '咣当', d: '产量 +15%，额外产矿铁 0.002/s', prodMul: 1.15, extraP: { iron: 0.002 },
      tip: ['一镐下去声音不对——好消息，是铁。'] },
  },
  hunter: {
