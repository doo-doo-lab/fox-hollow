# Nummon
- Nummon（概览）是一个计算脚本，服务于网页模拟建设游戏[猫国建设者](https://likexia.gitee.io/cat-zh/)。
  - <strong>最新版国内汉化网址：https://likexia.gitee.io/cat-zh/ </strong>，（*版本号675，可以在右上角选项导入导出存档*）

> 注意：现在 **最新中文版已经集成了Nummon** （概览），并且是自动打开。
...
- 每次献祭得到的时间水晶：指受太阳尖顶、独角兽理想国影响下每次献祭天角兽得到的水晶数量。
- 每次时间水晶精炼得到遗物：指受黑色连接、黑金字塔影响下每次献祭时间水晶得到的遗物数量。
- 每跳一年的水晶收入：指燃烧水晶后获得难得素全部用于贸易利维坦的水晶收入期望值。
- 下个资源回复水晶回本须跳（年）：指点下一级资源回复的时间水晶成本 / 通过点下一级资源回复提高每次燃烧时间水晶所获得难得素全部用于贸易利维坦获得的时间水晶。<br>成本是指数增长，资源回复的效果是线性，所以点高了之后需要很久时间回本。[具体资源回复数量<a href="?file=002-常用资料/012-数学技巧#给定收入和小时的最佳时计炉和资源回复" target="_Blank">获取水晶</a>]

### 其他
- 钍反应堆每秒耗铀：指点出钍反应堆后，反应堆每秒总共需要的铀的数量。（包括需要的钍转化为铀的数量）
- 距离黑暗未来到来年份：黑暗未来提高燃烧水晶成本惩罚到来的年份。(注意燃烧领导力不受影响，此值为正就不会触发黑暗未来的惩罚）
- 获取最佳遗物建筑: 指提高获得的遗物数量的建筑，注意黑金字塔需要悲伤上限也就是黑之核心。（后面的数字为推荐当前建筑所需要建筑的数量）
