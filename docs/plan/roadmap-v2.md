...
| 5.1b | 工业 D — 主建筑加速器+熔炉 | ✅ 已完成 | 8f976ca | §八 5.1b |
| 5.1c | 工业 D — 研究链 13 项 | ✅ 已完成 | 14bc161 | §八 5.1c |
| 5.1d | 工业 D — 职业辉能士 + 3 配方 | ✅ 已完成 | f5c9a8f | §八 5.1d |
| 5.1e | 工业 D — 升级 #79-106 | ✅ 已完成 | 18059b6 | §八 5.1e |
| 5.1f | 工业 D — UI 集成 + 子阶段验收 | ✅ 已完成 | b1a61f4 | §八 5.1f |
| 5.2a | 灵修 D — 资源 4 + 存储灵匣 | ✅ 已完成 | 55415e9 | §八 5.2a |
| 5.2b | 灵修 D — 主建筑元念池+寂石窟 | ✅ 已完成 | f6909d3 | §八 5.2b |
| 5.2c | 灵修 D — 研究链 18 项 | ✅ 已完成 | 1aae0d6 | §八 5.2c |
| 5.2d | 灵修 D — 职业 2 + 配方 5 | ✅ 已完成 | d4733cb | §八 5.2d |
| 5.2e | 灵修 D — 升级 #79-120（42 项）| ✅ 已完成 | 9389775 | §八 5.2e |
| 5.2f | 灵修 D — 灵术 5 + 灵契系统 + 寂石冥想 + UI 整体验收 | ✅ 已完成 | 191c05b | §八 5.2f |
| 5.3a | 神启 C — 教团资源 3 + 主建筑 8 | ✅ 已完成 | 23f76aa | §八 5.3a |
| 5.3b | 神启 C — 教团研究 12 + 职业 2 + 配方 5 | ✅ 已完成 | 52294b8 | §八 5.3b |
| 5.3c | 神启 C — 教团升级 35 项（#31-65）| ✅ 已完成 | 0e3e778 | §八 5.3c |
| 5.3d | 神启 C — 秘仪资源 3 + 主建筑 8 | ✅ 已完成 | _PLACEHOLDER_ | §八 5.3d |
| 5.3e | 神启 C — 秘仪研究 12 + 配方 5 | ⏳ 进行中 | - | §八 5.3e |
| 5.3f | 神启 C — 秘仪升级 35 项 + 飞升 3-4 门 | ⬜ 未开始 | - | §八 5.3f |
| 5.3g | 神启 C — 整体验收 | ⬜ 未开始 | - | §八 5.3g |
...
| 子任务 | 标题 | 涉及范围 | 估算 LoC | 依赖 |
|--------|------|---------|---------|------|
| 5.2a | 资源 4 + 存储灵匣 | data.js RD 4 + BD spiritVault | ~30 | 5.1f ✅ |
| 5.2b | 主建筑元念池+寂石窟 | data.js BD 2 条 | ~30 | 5.2a |
| 5.2c | 研究链 18 项 | data.js UD 18 条 + engine-actions/ui *U 解锁 | ~110 | 5.2a-b |
| 5.2d | 职业 2 + 配方 5 | data.js JD 2 + CD 5 | ~70 | 5.2c |
| 5.2e | 升级 #79-120（42 项）| data.js UPGD 42 条 + engine.js 必要 effect | ~220 | 5.2d |
| 5.2f | 灵术 5 + 灵契系统 + 寂石冥想 + UI 整体验收 | data.js SD 5 + 灵契数据/系统 + 冥想机制 + ui 集成 | ~250 | 5.2a-e |

> 每子任务独立 commit，独立通过验收清单。最终 5.2f 完成后整个 §八 5.2 标 ✅。
...
| 文件 | 改动 | 内容 |
|------|------|------|
| data.js RD | 新增 4 条 | 元念 `primordial`、寂石 `silenceStone`、镜灵 `mirrorSpirit`、虚典 `voidCodex`（设计文档名"幽典"，代码 ID `voidCodex` 跟设计映射）|
| data.js BD | 新增 1 条 | 灵匣 `spiritVault`（D 阶段灵修存储建筑）|
| index.html | cache-bust | data.js +1 |

###### 验收清单

- [ ] RD 4 条新资源 ID 全 truthy
- [ ] BD.spiritVault 字段完整
- [ ] preview_console_logs level=error = 0
- [ ] 旧存档加载: G.res 4 资源全 init `{v:0, mx:RD.mx, on:false}`
- [ ] chk(BD.spiritVault.uq) 在 primordialPool:1 时通过（5.2b 引入后）
...
| 子任务 | 标题 | 涉及范围 | 估算 LoC | 依赖 |
|--------|------|---------|---------|------|
| 5.3a | 教团资源 3 + 主建筑 8 | data.js RD 3 + BD 8 | ~80 | 5.2f ✅ |
| 5.3b | 教团研究 12 + 职业 2 + 配方 5 | data.js UD 12 + JD 2 + CD 5 + engine *U 解锁 | ~140 | 5.3a |
| 5.3c | 教团升级 35 项（#31-65）| data.js UPGD 35 | ~160 | 5.3b |
| 5.3d | 秘仪资源 3 + 主建筑 8 | data.js RD 3 + BD 8 | ~80 | 5.3a |
| 5.3e | 秘仪研究 12 + 配方 5 | data.js UD 12 + CD 5 + engine *U 解锁 | ~110 | 5.3d |
| 5.3f | 秘仪升级 35 项 + 飞升 3-4 门 | data.js UPGD 35 + GATE_DEF 扩展 | ~180 | 5.3e |
| 5.3g | 整体验收 | preview 验证 + UI 集成检查 + 进度表 | ~30 | 5.3a-f |

> 教团/秘仪可并行（5.3d 仅依赖 5.3a 资源/建筑入库，不依赖 5.3b-c）。
> 但建议按 a→b→c→d→e→f→g 顺序确保单 commit 可独立验收。
...
| 文件 | 改动 | 内容 |
|------|------|------|
| data.js RD | 新增 3 条 | 颂咏 `hymn`、圣骸 `holyRelic`、圣典 `holyScripture`（全部 sb:'D' 副线门控）|
| data.js BD | 新增 8 条 | cathedral / hymnHall / pilgrimage / relicShrine / crusadeCamp / scriptureSpire / atonementPool / holyAltar |
| index.html | cache-bust | data.js +1 |

###### 验收清单

- [ ] RD 3 新资源全 truthy + lock=1
- [ ] BD 8 新建筑字段完整
- [ ] preview reload + console error = 0
- [ ] 旧存档加载 G.res + G.bld 新条目正确 init
- [ ] anyBranchLocked: 教团副线（sb:'D'+br:'I'）正确门控
